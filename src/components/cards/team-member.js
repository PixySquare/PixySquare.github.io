...
import { FaTwitter, FaGithub, FaInstagram, FaLinkedin, FaGlobe, FaBehance } from 'react-icons/fa';
          ...
          {member?.socialLinks?.map((social, index) => (
            <Link href={social?.link} key={index}>
              ...
              {social?.name === 'instagram' && (
                <FaInstagram size="18px" color="#161614" />
              )}
              {social?.name === 'website' && (
                <FaGlobe size="18px" color="#161614" />
              )}
              {social?.name === 'behance' && (
                <FaBehance size="18px" color="#161614" />
              )}
              {social?.name === 'twitter' && (
